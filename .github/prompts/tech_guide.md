...
│
├── .thumbs/               # Shared, public directory for generated thumbnails
...
4.  **Static Assets (Thumbnails):**
    *   The `.thumbs/` directory at the root needs to be served statically. During development, you can configure Vite's dev server to serve this directory. For production, a web server like Nginx would be configured to serve this path, or your FastAPI app could be configured to serve it. This keeps image-serving load off the main API logic.
